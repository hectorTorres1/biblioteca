...
<html lang="en">
  <head>
    ...
    <body>
        ...
        <nav class="white">
            <div class="wrapper">
                <a href="#!" class="brand-logo center">Historial de Prestamos</a>
            </div>
            ...
            <tbody>
                <?php
                    ...
                    if(isset($_GET["buscar"]) && $_GET["buscar"]!=""){
                        ...
                        $sql="select id_prestamo, titulo, autor, editorial, clasificacion, nombre, carrera, estatus, fechaEntrega, estatus from prestamos order by id_prestamo desc "; 
                    }
